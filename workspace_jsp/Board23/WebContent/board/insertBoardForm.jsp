...
document.addEventListener("DOMContentLoaded", function() {
	...
	btnInsert.addEventListener("click", function() {
		...
		if(!form.pwd.value) { // form.pwd.value.length == 0 (!(not)을 붙일때는 .length는 필요없다.)
			alert("패스워드를 입력 하시오.");
			form.pwd.focus();
			return;   
		}
...
<div id="container">
   ...
   <table>
      <tr>
         <th>작성자</th>
         <td><input type="text" name="writer" size="49" maxlength="30"></td>
      </tr>
      <tr>
         <th>제목</th>
      ...
      <tr>
         <th>이메일</th>
         <td><input type="email" name="email" size="49" maxlength="30"></td>
      </tr>
      <tr>
         <th>내용</th>
      ...
      <tr>
         <th>패스워드</th>
         <td><input type="password" name="pwd" size="49"></td>
      </tr>
      <tr>
