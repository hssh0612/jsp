...
<div id="container">
   ...
   <table>
      ...
      <tr>
         <th>작성자</th>
         <td><input type="text" name="writer" value="<%=board.getWriter() %>" size="52" maxlength="30" readonly class="read"></td>      
      </tr>
      <tr>
         <th>이메일</th>
         <td><input type="email" name="email" value="<%=board.getEmail() %>" size="52" maxlength="30" readonly class="read"></td>      
      </tr>
      <tr>
         <th>제목</th>
      ...
      <tr>
         <th>내용</th>
         <td><textarea name = "content" cols="54.5" rows="20"><%=board.getContent() %></textarea></td>      
      </tr>
   </table>
   <div class="btns">
